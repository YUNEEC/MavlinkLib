...
typedef struct __mavlink_visual_tracking_t {
 ...
 float size; /*< =The size of the visual target*/
 float width; /*< =The width of the visual target*/
 float height; /*< =The height of the visual target*/
 ...
 *
 * @return =The size of the visual target
 */
 ...
 *
 * @return =The width of the visual target
 */
 ...
 *
 * @return =The height of the visual target
 */
