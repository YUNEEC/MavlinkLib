...
{
   MAV_CMD_TASK_VISUAL_TRACKING=0, /* visual tracking. |=1,Pause the current task; =0 Continue the current task| =0,visual tracking;=1 parallel to follow| Empty| Empty| Empty| Empty|  */
   MAV_CMD_TASK_OBRIT=1, /* Flying around the user. |=1,Pause the current task; =0 Continue the current task| radius| velocity| Empty| Empty| Empty|  */
   MAV_CMD_TASK_POI=2, /* Specify points of intersest and fly around points of interest. |=1,Pause the current task; =0 Continue the current task| =0 ;=1,ready POI,get to the point of interset;= 2,POI mode start| velocity| radius| =1 gimbal visuial adjust| Empty|  */
   MAV_CMD_TASK_JOUR=3, /* Jour mode. |=1,Pause the current task; =0 Continue the current task| velocity| distance| = 1,JOUR mode start| Empty| Empty|  */
   MAV_CMD_TASK_GPS_FOLLOW=4, /* Move through the gps follow the target. |Empty| Empty| Empty| Empty|  =1,gimbal visuial adjust| Empty|  */
   MAV_CMD_TASK_CCC=5, /* Spline Curves. Full name:Curve Cable Cam. |Empty| Empty| Empty| Empty| Empty| Empty|  */
   FLIGHT_TASK_ENUM_END=6, /*  | */
} FLIGHT_TASK;
#endif
