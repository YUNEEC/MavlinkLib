...
typedef enum FLIGHT_TASK
{
   ...
   FLIGHT_TASK_POI=2, /* Specify points of interest and fly around points of interest. |=1, Pause the current task; =2 Continue/start the current task.| Around the radius, the unit is meters, range (5-50m)| Flight velocity, unit is m/s,range (1-10)| Surround direction, =0 clockwise rotation, =1 Anticlockwise rotation.| Choose how to draw points of interest, =0 Manually draw points of interest, =1 Automatically draw points of interest.| Empty|  */
...
#include "./mavlink_msg_exposure_info_request.h"
#include "./mavlink_msg_exposure_info_ack.h"
#include "./mavlink_msg_slave_channels.h"
